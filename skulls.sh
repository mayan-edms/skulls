...
usage()
{
	...
	echo ""
	echo "Usage: $0 -b (x230|x230t|t430|t440p|t530|t540p|w530) [-i <4mb_top_image>.rom] [-U] [-h]"
	echo "Options:"
	echo "  -b	board to flash. This must be \"x230\", \"x230t\", \"t430\", \"t440p\", \"t530\", \"t540p\" or \"w530\""
